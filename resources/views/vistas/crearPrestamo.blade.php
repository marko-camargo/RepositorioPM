    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <!-- Topbar Navbar -->
          <h1 class="h3 mb-4 text-gray-800">PEDIR PRÉSTAMO</h1>
                        ...
                        <div class="col-lg-6">
                          <div class="p-5">
                            <div class="text-center">
                              <h1 class="h4 text-gray-900 mb-4">DATOS DEL PRÉSTAMO</h1>
                            </div>
                            <form class="user" method="POST" action="/cuentaCRUD">
                            ...
                            <input type="hidden" name="IdInput" value="{{$id}}"> 
                              ...
                              <div class="form-group">
                                <input type="text" class="form-control form-control-user" name="ComentariosInput" placeholder="Comentarios...">
                                {{csrf_field()}}
                              </div>
