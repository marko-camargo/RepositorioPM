                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="p-5">
                          ...
                          <form class="user" method="POST" action="/usuarioCRUD">
                            ...
                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" name="IdsucursalInput" placeholder="Id Sucursal...">
                              {{csrf_field()}}
                            </div>
                            ...
                            <div class="form-group">
                              <!--<input type="text" class="form-control form-control-user" name="PuestoInput" placeholder="Puesto...">-->
                            ...
                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" name="UsernameInput" placeholder="Nombre de usuario...">
                              {{csrf_field()}}
                            </div>

                            <div class="form-group">
                              <input type="password" class="form-control form-control-user" name="PasswordInput" placeholder="Contraseña...">
                              {{csrf_field()}}
                            </div>
