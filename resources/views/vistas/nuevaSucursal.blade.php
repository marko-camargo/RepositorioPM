                      ...
                      <div class="col-lg-6">
                        <div class="p-5">
                          <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">REGISTRO SUCURSAL</h1>
                          </div>
                          <form class="user" method="POST" action="/sucursalCRUD">
                            ...
                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" name="DireccionInput" placeholder="Dirección...">
                              {{csrf_field()}}
                            </div>

                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" name="CPInput" placeholder="Código Postal...">
                              {{csrf_field()}}
                            </div>

                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" name="CiudadInput" placeholder="Ciudad...">
                              {{csrf_field()}}
                            </div>
