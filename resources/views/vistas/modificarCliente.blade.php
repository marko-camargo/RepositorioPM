                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="p-5">
                          ...
                          <form class="user" method="POST" action="/clienteCRUD/{{$cliente->id_cliente}}"> 
                            @csrf
                            <input type="hidden" name="_method" value="PUT">

                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" name="NombreInput" placeholder="Nombre..." value="{{$cliente->Nombre}}">
                              {{csrf_field()}}
                            </div>

                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" name="DomicilioInput" placeholder="Domicilio..." value="{{$cliente->Domicilio}}">
                              {{csrf_field()}}
                            </div>

                            <div class="form-group">
                              <input type="date" class="form-control form-control-user" name="FechanacInput" placeholder="FechaNac YYYY-MM-DD..." value="{{$cliente->FechaNac}}">
                              {{csrf_field()}}
                            </div>

                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" name="EmailInput" placeholder="Email..." value="{{$cliente->Email}}">
                              {{csrf_field()}}
                            </div>

                            <div class="form-group">
                              <input type="text" class="form-control form-control-user" name="TelefonoInput" placeholder="Telefono/Celular..." value="{{$cliente->Telefono}}">
                              {{csrf_field()}}
                            </div>
